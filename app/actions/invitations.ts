...
import { invitations, user as userTable } from '@/lib/db/schema'
...
export async function resendInvitation(
  ...
  return createInvitation({ email: invite.email, role: invite.role as Role })
}
...
export async function validateInvitationToken(
  ...
  | { ok: true; email: string; role: Role; invitedByName: string | null }
...
> {
  ...
  return { ok: true, email: invite.email, role: invite.role as Role, invitedByName: invite.invitedByName }
}
