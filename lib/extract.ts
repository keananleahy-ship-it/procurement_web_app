...
- Container/package parsing (set packSize = capacity number, baseUnit = its unit):
  ...
  - Slash "count/size" pack notation means count × per-container size (same as a multiplier). If a unit is printed on the size, use it: "4/1 GAL" => packSize 4, baseUnit "USG"; "6/5 L" => packSize 30, baseUnit "litre". When the size after the slash is a BARE number with no unit, it is expressed in QUARTS on this sheet: "12/1" => 12 × 1 quart => packSize 12, baseUnit "quart" (this is a 12 x 1-quart case, i.e. 3 gallons); "6/4" => 6 × 4 quart => packSize 24, baseUnit "quart". Set containerAmbiguous false for these — they are a known convention.
